...
interface ModalUserDetailPageProps {
  params: {
    id: string
  }
}
const ModalUserDetailPage = ({ params: { id } }: ModalUserDetailPageProps) => {
    ...
    <div className='fixed inset-0 bg-zinc-900/20 z-10'>
      <div className='flex items-center h-full max-w-lg mx-auto p-5'>
        <div className='relative bg-white w-full py-5 px-5 rounded-lg'>
          ...
          <button className='absolute top-4 right-4 cursor-pointer' onClick={e => router.back()}><RiCloseFill className='text-2xl' /></button>
...
export default ModalUserDetailPage